 ...
 * Upstream parses into `usize` and materializes the full valid length; an
 * overflowing literal fails the parse and falls back to the default length —
 * `Number.isSafeInteger` is the closest JS equivalent of that bound. */
